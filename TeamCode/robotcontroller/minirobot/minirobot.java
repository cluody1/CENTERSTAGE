package org.firstinspires.ftc.robotcontroller.minirobot;
...
public class minirobot extends OpMode
{
    ...
    public void loop() {
        ...
        if (gamepad1.left_bumper) {
            gripperLeft.setPosition(gripperOpenPosition);
            gripperRight.setPosition(gripperOpenPosition);

        }
        if (gamepad1.right_bumper) {
            gripperLeft.setPosition(gripperClosedPosition);
            gripperRight.setPosition(gripperClosedPosition);
        }
